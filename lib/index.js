...
module.exports = function(options) {
  ...
  var jwtVerifyOptionsCallback = options.jwtVerifyOptions;

  if (!isFunction(jwtVerifyOptionsCallback)){
    jwtVerifyOptionsCallback = function(_, __, cb) { return cb(null, options); };
  }
  ...
  var middleware = function(req, res, next) {
    ...
    async.waterfall([
      ...
      function jwtVerifyOptions(secret, callback) {
        jwtVerifyOptionsCallback(req, dtoken.header, dtoken.payload, function(err, jwtOptions) {
          if (err) {
            callback(new UnauthorizedError('invalid_jwt_verify_options', err));
          } else {
            callback(null, secret, jwtOptions);
          }
        });
      },
      function verifyToken(secret, jwtOptions, callback) {
